    ...
    <section className='min-h-screen flex justify-center items-center pt-20 relative overflow-hidden'>
      ...
      <div className='max-w-6xl mx-auto px-6 text-center z-20'>
        <RevealOnScroll>
          ...
          <h1 className='text-5xl md:text-7xl font-black tracking-tighter mb-0 text-white/40 leading-[0.9]'>
            <HackerEffect 
              text="KAMIL HASSAN" 
              speed={80} 
              className=""
            ...
            <TypeAnimation
              ...
              speed={50}
              repeat={Infinity}
              className="text-4xl md:text-8xl bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-600 text-transparent bg-clip-text text-glow font-bold"
            />
          </h1>
        </RevealOnScroll>
